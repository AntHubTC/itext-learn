...
public class Demo10 {
    ...
    public static final String DATA = "in/premier_league.csv";
    public static final String DEST = "out/demo10.pdf";
    ...
    private class RoundedCornersCellRenderer extends CellRenderer {
        ...
        public void drawBorder(DrawContext drawContext) {
            ...
            float urx = rectangle.getX() + rectangle.getWidth() - 1;
            float ury = rectangle.getY() + rectangle.getHeight() - 1;
